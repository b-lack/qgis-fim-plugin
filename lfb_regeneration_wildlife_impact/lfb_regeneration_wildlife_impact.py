...
# https://gist.github.com/maximlt/9178dca844ff70c73367d9111197faa8
import sys
import traceback
...
class LfbRegenerationWildlifeImpact:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'LfbRegenerationWildlifeImpact_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Lfb Regeneration and Wildlife Impact Monitoring')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('LfbRegenerationWildlifeImpact', message)
    ...
    def initGui(self):
        ...
        self.add_action(
            icon_path,
            text=self.tr(u'Add Regeneration and Wildlife Impact Plot'),
            callback=self.run,
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginVectorMenu(
                self.tr(u'&Lfb Regeneration and Wildlife Impact Monitoring'),
                action)
    ...
    def run(self):
        ...
        if self.first_start == True or self.dlg is None:
